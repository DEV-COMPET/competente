...
const envSchema = z.object({
    ...
    AUTENTIQUE_TALKS_RECIPIENT_NAME: z.string(),
    AUTENTIQUE_TALKS_RECIPIENT_EMAIL: z.string(),
    AUTENTIQUE_COMPLETION_RECIPIENT_NAME: z.string(),
    AUTENTIQUE_COMPLETION_RECIPIENT_EMAIL: z.string(),
