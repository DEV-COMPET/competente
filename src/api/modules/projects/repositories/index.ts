...
import { MemberData } from './defaultMongoDBRepository/projectMemberRepository';
...
export type ProjectMemberRepository = Repository<ProjectMemberType> & { update: (nome: string, updatedData: MemberData) => Promise<ProjectMemberType | undefined> };
