...
import selectEventNameMenuData from "../../../selectMenus/talksSpeakerCertificate/selectTalksNameMenuData.json";
...
const { name, description }: ChatInputApplicationCommandData = readJsonFile({
    dirname: __dirname,
    partialPath: "talksSpeakerCertificateInput.json"
});

/**
 * @author Pedro Vitor Melo Bitencourt
 * @description Comando que gera o certificado de um palestrante
 */
