...
export default new Command({
    ...
    options: [{ name: "new_scrum_mail", description: "O email do mais novo scrum", type: ApplicationCommandOptionType.String, required: true }],
                ...
                if (!data.scrum_master) {
                    ...
                    if (response.status >= 200 && response.status < 300) {
                        ...
                        const embed = new EmbedBuilder()
                            ...
                            .setThumbnail("https://img2.gratispng.com/20180303/ueq/kisspng-crown-king-scalable-vector-graphics-clip-art-cartoon-exquisite-crown-5a9b7b715dca16.7784451515201391213842.jpg")
                            .addFields(
                        ...
                        embed.setTimestamp()
                        await interaction.reply({ content: "O mais novo scrum tá na área", ephemeral: false, embeds: [embed] })
                    } else {
                        const embed = new EmbedBuilder()
                            .setColor(0xF56565)
                            ...
                            .addFields(
                                ...
                                { name: "Mensagem do erro", value: "Não foi possivel tornar o membro em questão scrum do compet!", inline: false },
                            )
                        return await interaction.reply({ content: "Não foi possível executar este comando", ephemeral: true, embeds: [embed] })
                    }
                    ...
                    const embed = new EmbedBuilder()
                        ...
                        .addFields(
                            ...
                            { name: "Mensagem do erro", value: "O membro já é scrum!", inline: false },
                        )
                    return await interaction.reply({ content: "Não foi possível executar este comando", ephemeral: true, embeds: [embed] })
                }
